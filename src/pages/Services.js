...
import MusicProduction from '../assets/MusicProduction.png';
import ArtistDevelopment from '../assets/artistdev.webp';
  ...
  return (
    <div className="services-container">
      ...
      <div className="service">
        <img src={MusicProduction} alt="Service 1" className="service-image" />
      ...
      <div className="service">
        <img src={ArtistDevelopment} alt="Service 2" className="service-image" />
        <div className="service-details">
